...
#!/bin/bash
cd /var/www/html
echo '<html><head><title>Stable Difusion Perfectly!</title></head> <body><img src="http://${yandex_storage_bucket.loveyourvoice.bucket_domain_name}/image.png"/></body></html>' > index.html
EOF
    }
  }
